    ...
    describe('runCode()', () => {
        ...
        describe('and the code includes EQ', () => {
            it('checks two values are equal', () => {
                ...
                expect(new Interpreter().runCode([PUSH, 3, PUSH, 3, EQ, STOP])).toEqual(1);
            });
        });
        ...
        describe('and the code includes infinte loop', () => {
            it('throws an error', () => {
                expect(() => new Interpreter().runCode([PUSH, 0, JUMP, STOP])).toThrow('Check for infinite loop. Excecution limit of 10000 exceeded')
            })
        })
    });
});